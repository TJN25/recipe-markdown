...
??? note "Ingredients"
    ...
    ??? info "Prep Steps"
        ...
        2. Measure out butter, flour, milk
...
??? note "Cooking Instructions"
    ...
    ??? info "Assembly"
        1. Mix overcooked pasta into sauce (should look too saucy - it will thicken)
        2. Transfer to medium casserole dish
        3. Top with remaining cheese mix (74g total)
        4. Place in toaster oven on grill setting
        5. Grill 5-6 minutes until top is golden and bubbly with some darker spots
    ...
    ??? info "Signs of Success"
        - Sauce should be very creamy, not grainy
...
??? note "Storage"
    ...
    - Store second portion in airtight container
    - Reheat with splash of milk, stirring frequently
    - For best results when reheating, use stovetop rather than microwave

    ??? info "Enhancement Notes"
        - For extra texture, consider adding 3 tbsp of frozen corn when mixing in the chicken
