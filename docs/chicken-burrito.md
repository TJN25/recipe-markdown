...
??? note "Ingredients"
    ...
    - 50g [Mexican chicken](mexican-chicken-marinade.md) (protein, flavor base)
    ...
    - Small handful [pickled red onions](pickled-red-onion.md) (acid, crunch)
...
??? note "Technical Notes"
    - Layering order is crucial for proper texture and to prevent soggy tortilla
    - Ensure filling is centered and not overfilled for proper rolling
    - Press down gently while rolling to keep it tight
    - If tortilla tears, start fresh (tears will worsen during cooking)
